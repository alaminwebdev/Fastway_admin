  ...
  <div class="card card-success">
        ...
        <div class="row align-items-center">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="checkbox" name="delivery_type" id="delivery_type" <?php echo isset($delivery_type) && $delivery_type == 1 ? 'checked' : '' ?> data-bootstrap-switch data-toggle="toggle" data-on="Regular" data-off="Express" class="switch-toggle status_chk" data-size="xs" data-offstyle="danger"  data-width="5rem" value="1">
              <small>Regular = Regular form of shipping</small>
              <small>,Express = Fastest form of shipping</small>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group" id="dbi-field">
              <label for="" class="control-label">Parcel Type</label>
              <select name="parcel_type" id="parcel_type" class="form-control select2" required="">
                <option value=""></option>
        ...
        <?php if (!isset($id)) : ?>
          <div class="row">
            <div class="col-md-12 d-flex justify-content-end">
              <button class="btn btn-sm btn-success " type="button" id="new_parcel"><i class="fa fa-item"></i> Add Item</button>
            </div>
          </div>
        <?php endif; ?>
      </form>
    ...
    <div class="card-footer border-info">
      <div class="d-flex w-100 justify-content-center align-items-center">
        <button class="btn btn-success mx-2" form="manage-parcel">Save</button>
        <a class="btn btn-danger mx-2" href="./index.php?page=parcel_list">Cancel</a>
      </div>
    </div>
  </div>
</div>
