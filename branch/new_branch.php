  ...
  <div class="card card-primary">
          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-sm-6 form-group ">
                ...
                <textarea name="address" id="" cols="30" rows="1" class="form-control"><?php echo isset($address) ? $address : '' ?></textarea>
              </div>
              <div class="col-sm-6 form-group ">
    ...
    <div class="card-footer border-info">
      <div class="d-flex w-100 justify-content-center align-items-center">
        <button class="btn btn-success mx-2" form="manage-branch">Save</button>
        <a class="btn btn-danger mx-2" href="./index.php?page=branch/branch_list">Cancel</a>
      </div>
    </div>
  </div>
</div>
    ...
    $.ajax({
      ...
      success: function(resp) {
        if (resp == 1) {
          ...
          setTimeout(function() {
            location.href = 'index.php?page=branch/branch_list'
          }, 2000)
        }
      }
    })
