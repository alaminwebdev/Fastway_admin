	...
	<div class="card card-success">
		<div class="card-body">
			<div class="d-flex w-100 px-1 py-2 justify-content-center align-items-center">
				...
				<label for="date_from" class="mx-2 mb-0">Status</label>
				...
				<label for="date_from" class="mx-2 mb-0">From</label>
				...
				<label for="date_to" class="mx-2 mb-0">To</label>
				...
				<button class="btn btn-sm btn-success mx-2" type="button" id='view_report'>View Report</button>
			</div>
		</div>
	</div>
	<div class="row">
