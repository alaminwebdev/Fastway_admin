  <aside class="main-sidebar sidebar-light-success elevation-4 overflow-auto">
    <div class="dropdown">
      <a href="./" class="brand-link ">
        <img src="assets/dist/img/fastway-mini.gif" alt="Fastway Logo" class="brand-image">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <?php if ($_SESSION['login_type'] == 1) : ?>
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="./index.php?page=branch/new_branch" class="nav-link nav-new_branch tree-item">
                    <i class="fas fa-angle-right nav-icon"></i>
                    <p>Add New</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="./index.php?page=branch/branch_list" class="nav-link nav-branch_list tree-item">
                    <i class="fas fa-angle-right nav-icon"></i>
                    <p>List</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="./index.php?page=staff/new_staff" class="nav-link nav-new_staff tree-item">
                    <i class="fas fa-angle-right nav-icon"></i>
                    <p>Add New</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="./index.php?page=staff/staff_list" class="nav-link nav-staff_list tree-item">
                    <i class="fas fa-angle-right nav-icon"></i>
                    <p>List</p>
                  </a>
                </li>
          ...
          <?php if ($_SESSION['login_type'] == 2) : ?>
            <li class="nav-item dropdown">
              <a href="./index.php?page=parcel_list&s=10" class="nav-link nav-request">
            ...
            <li class="nav-item dropdown">
              <a href="https://dashboard.tawk.to/#/chat/" class="nav-link nav-support" target="_blank">
