...
<div class="col-lg-12">
	<div class="card card-success">
		<div class="card-body">
			<div class="d-flex w-100 px-1 py-3 justify-content-center align-items-center">
				<label for="" class="my-0">Enter Tracking Number : </label>
				<div class="input-group col-sm-5">
					<input type="search" id="ref_no" class="form-control form-control" placeholder="Type the tracking number here">
					<div class="input-group-append">
						<button type="button" id="track-btn" class="btn btn btn-success">
